...
export const COMPASS_ROOT_DIR_NAME = 'chatbuddy-compass';
...
export const COMPASS_LAYOUT_VERSION = 2;
...
export function createCompassPaths(globalStoragePath: string): CompassPaths {
  const rootPath = path.join(globalStoragePath, COMPASS_ROOT_DIR_NAME);
