...
const REGISTRY: Record<string, RegistryEntry> = {
  ...
  'gpt-5.5': { kind: 'chat', capabilities: { vision: true, tools: true, reasoning: true, webSearch: true } },
  'gpt-5.5-pro': { kind: 'chat', capabilities: { vision: true, tools: true, reasoning: true, webSearch: true } },
  ...
  'gpt-4.1': { kind: 'chat', capabilities: { vision: true, tools: true, webSearch: true } },
  'gpt-4.1-mini': { kind: 'chat', capabilities: { vision: true, tools: true, webSearch: true } },
  'gpt-4.1-nano': { kind: 'chat', capabilities: { vision: true, tools: true, webSearch: true } },
  ...
  'o3-mini': { kind: 'chat', capabilities: { vision: true, reasoning: true, tools: true } },
  ...
  'deepseek-reasoner': { kind: 'chat', capabilities: { reasoning: true, tools: true } },
  'deepseek-r1': { kind: 'chat', capabilities: { reasoning: true, tools: true } },
  'deepseek-v4': { kind: 'chat', capabilities: { tools: true, reasoning: true } },
  'deepseek-v4-flash': { kind: 'chat', capabilities: { tools: true, reasoning: true } },
  'deepseek-v4-pro': { kind: 'chat', capabilities: { tools: true, reasoning: true } },
  'deepseek-v3': { kind: 'chat', capabilities: { tools: true } },
  'deepseek-r1-0528': { kind: 'chat', capabilities: { reasoning: true, tools: true } },
  'deepseek-prover-v2': { kind: 'chat', capabilities: { reasoning: true } },
